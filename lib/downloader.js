...
const DEFAULT_PROGRESS_THROTTLE = 1000;
...
class Downloader extends EventEmitter {
  constructor(options) {
    ...
    }, options.progressThrottle || DEFAULT_PROGRESS_THROTTLE);
...
exports.download = (url, localFile, appendFileExt, progressCB, progressThrottle) =>
  mkdirp(path.dirname(localFile))
  .then(() => new Promise((resolve, reject) => {
    new Downloader({ url, filename: localFile, appendFileExt, progressCB, progressThrottle })
